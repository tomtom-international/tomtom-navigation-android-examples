...
// The speed bubble is shown even in browsing mode, it overlaps the center button
class BasicNavActivity : AppCompatActivity() , RouteProcessFragment.NavigateOptionsInterface{
    ...
    // Handling search should be delegated to some other fragment or viewmodel this class is huge and hard to follow
    // Search API
    ...
    private lateinit var locationUpdateListener:OnLocationUpdateListener // Some configuration for checking code style would be nice
    ...
    // Move onCreate to be the first method, it is easier to read from top to bottom and it is the first method called in this Activity
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(this,
                ...
                COARSE_REQUEST_CODE)
            // I would recommend using https://developer.android.com/training/permissions/requesting#allow-system-manage-request-code
            // for requesting the permissions. It simplifies the logic.
            return // You cannot return here because the rest of the code in onCreate is not executed
        }
        ...
        // Extract methods for configuring map, navigation and search
        // Adding Navigation
    ...
    private val routePlanningCallback = object : RoutePlanningCallback {
        ...
        override fun onRoutePlanned(route: Route) {
            ...
            drawRoute(route, true) // draw route should be done only in onSuccess, calling it here causes drawing route multiple times
        }
    }
