 ...
 */
package com.tomtom.sdk.examples.usecase.online
...
class OnlineNavigationActivity : AppCompatActivity() {
    ...
    private val routePlanningCallback = object : RoutePlanningCallback {
        ...
        override fun onFailure(failure: RoutingFailure) {
            Toast.makeText(this@OnlineNavigationActivity, failure.message, Toast.LENGTH_SHORT).show()
        }
